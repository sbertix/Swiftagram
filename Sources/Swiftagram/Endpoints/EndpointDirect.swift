...
public extension Endpoint {
    ...
    struct Direct {
        ...
        public static func threads(startingAt page: String? = nil) -> PaginatedResponse {
            return base.inbox
                .appending(query: ["visual_message_return_type": "unseen",
                                   ...
                                   "limit": "20"])
                .paginating(key: "cursor", keyPath: \.oldestCursor, value: page)
                .locking(Secret.self)
        }

        /// All pending threads.
        /// - parameter page: An optional `String` holding reference to a valid cursor. Defaults to `nil`.
        public static func pendingThreads(startingAt page: String? = nil) -> PaginatedResponse {
        ...
        public static func recipients(matching query: String? = nil) -> DisposableResponse {
        ...
        public static func thread(matching identifier: String,
                                  startingAt page: String? = nil) -> PaginatedResponse {
            return base.threads

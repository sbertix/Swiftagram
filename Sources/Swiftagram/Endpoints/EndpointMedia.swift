...
public extension Endpoint {
    ...
    struct Media {
        ...
        public static func likers(for identifier: String) -> Paginated<Lock<Request>, Response> {
            return base.locking(authenticator: \.header).append(identifier).likers.paginating()
        }
        ...
        public static func comments(for identifier: String) -> Paginated<Lock<Request>, Response> {
            return base.locking(authenticator: \.header).append(identifier).comments.paginating()
        }

        /// The permalinkg for the media matching `identifier`.
        /// - parameter identifier: A `String` holding reference to a valid media identifier.
        public static func permalink(for identifier: String) -> Lock<Request> {
            return base.locking(authenticator: \.header).append(identifier).permalink
        }

        // MARK: Actions
        /// Like the media matching `identifier`.
        /// - parameter identifier: A `String` holding reference to a valid media identifier.
        public static func like(_ identifier: String) -> Lock<Request> {
        ...
        /// - parameter identifier: A `String` holding reference to a valid media identifier.
        public static func unlike(_ identifier: String) -> Lock<Request> {
        ...
        public static func reportComment(_ identifier: String, in mediaIdentifier: String) -> Lock<Request> {

...
public extension Endpoint {
    ...
    struct Feed {
        ...
        public static func posts(by identifier: String) -> Paginated<Locked<ComposableRequest>, Response> {
            return base.user.append(identifier).paginating()
        }

        /// All available stories for user matching `identifier`.
        /// - parameter identifier: A `String` holding reference to a valid user identifier.
        public static func stories(by identifier: String) -> Paginated<Locked<ComposableRequest>, Response> {
            return base.user.append(identifier).reel_media.paginating()
        }

        /// All posts a user matching `identifier` is tagged in.
        /// - parameter identifier: A `String` holding reference to a valid user identifier.
        public static func posts(including identifier: String) -> Paginated<Locked<ComposableRequest>, Response> {
        ...
        public static func tagged(with tag: String) -> Paginated<Locked<ComposableRequest>, Response> {
